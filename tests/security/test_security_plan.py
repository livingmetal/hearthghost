...
REQUIRED_CASES = {
    ...
    "revoked-credential",
    "unknown-credential",
    "missing-node-client-certificate",
    "unknown-node-client-certificate",
    "node-certificate-resolver-unavailable",
    "expired-credential",
    ...
    "authenticated-node-auto-enrollment",
    "enrolled-node-auto-trust",
    "stale-node-administration-revision",
    "unadvertised-capability-administration-grant",
    "administration-audit-write-failure",
    "mock-node-plaintext-or-oversized-frame",
    "mock-node-revoked-capability",
    "mock-node-revoked-trust",
    "mock-node-revoked-credential-reconnect",
